...
def plot_example_serial_and_parallel(Nt =100):
    ...
    if (comm.rank == 0):
        ...
        #plt.plot(u_parallel1, 'r-', label='Parallel Solution dt')
        #plt.plot(u_parallel2, 'r-', label='Parallel Solution dt2')
        #plt.plot(u_parallel3, 'r-', label='Parallel Solution dt3')
        ...
        plt.savefig('./parallel_heat1.png')
